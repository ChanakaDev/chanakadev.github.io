    ...
    <footer className="w-full border-t mt-20 bg-slate-50 border-slate-200">
      <div className="max-w-[1140px] mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex flex-col items-center md:items-start gap-2">
          <div className="text-lg font-bold text-slate-900 font-headline-md">Dr. Julian Vane</div>
          <div className="font-headline-md text-sm text-slate-500">© 2024 Julian Vane. Research Scientist.</div>
        </div>
